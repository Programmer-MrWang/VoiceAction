...
namespace VoiceAction.UN.Actions;

[ActionInfo("VoiceAction.Unmute", "取消系统静音", "\uF00D", false)]
public class UnmuteVolumeAction : ActionBase
{
    private readonly ILogger<UnmuteVolumeAction> _logger;

    public UnmuteVolumeAction(ILogger<UnmuteVolumeAction> logger)
    {
        _logger = logger;
    }
